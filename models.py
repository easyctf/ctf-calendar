...
class Event(db.Model):
    ...
    # OAuth2 stuff
    client_id = db.Column(db.String(40), unique=True, default=util.generate_string_of(16))
    client_secret = db.Column(db.String(55), unique=True, index=True, nullable=False, default=util.generate_string_of(32));

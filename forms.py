...
class EventForm(Form):
    ...
    start_time = IntegerField("Start Time (UNIX Time)", validators=[InputRequired(), NumberRange(min=0, max=2147483647, message="Start time must be between 0 and 2147483647!")])
